...
const contractName = 'PermissionedHashmapSA'
const contractFilename = `${config.libPath}/auth/permission/contracts/PermissionedHashmapSA.sol`
const options = { config }

async function uploadContract(admin, permissionManager, options) {
...
function bind(admin, _contract, defaultOptions) {
  ...
  contract.getArray = async function (name, options = defaultOptions) {
    return await getArray(admin, contract, name, options)
  }
